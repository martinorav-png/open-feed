...
/// Run: OPEN FEED / Scripts / Store Flow Targeted Rebuild
/// </summary>
public static class StoreFlowTargetedRebuild
{
    const string MenuPath = "OPEN FEED/Scripts/Store Flow Targeted Rebuild";
    ...
    static void WireIntroAndDoors(GameObject root, Transform store)
    {
