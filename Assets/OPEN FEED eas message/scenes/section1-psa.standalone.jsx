...
function PlaceholderImage({ kind }) {
  ...
  // Real photo scenes
  if (kind === 'street') return <PhotoScene style={styles} src={window.__resources.liminalhouse} />;
  if (kind === 'lot') return <PhotoScene style={styles} src={window.__resources.carpark} />;
  if (kind === 'grocery') return <PhotoScene style={styles} src={window.__resources.stor1} />;
  if (kind === 'forest') return <PhotoScene style={styles} src={window.__resources.darkness} />;
  if (kind === 'driveway') return <PhotoScene style={styles} src={window.__resources.liminalhouse} />;
